        ...
        return next.handle(req).pipe(
            map((event: HttpEvent<any>) => {
                if (event instanceof HttpResponse) {
                    ...
                    if (responseBody.StatusCode && responseBody.StatusCode != 200 && responseBody.StatusCode != 201 && responseBody.StatusCode != 203 && responseBody.StatusCode != 204) {
                        console.log("вы проебались")
