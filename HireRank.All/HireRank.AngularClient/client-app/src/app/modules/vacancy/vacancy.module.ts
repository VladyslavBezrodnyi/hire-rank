...
import { VacancyRatingOverviewComponent } from './vacancy-rating-overview/vacancy-rating-overview.component';
...
@NgModule({
  declarations: [VacanciesListComponent, VacancyPageComponent, VacancyTestComponent, VacancyRatingOverviewComponent],
  imports: [
    CommonModule,
  ...
  exports: [
    VacancyRatingOverviewComponent
  ]
})
