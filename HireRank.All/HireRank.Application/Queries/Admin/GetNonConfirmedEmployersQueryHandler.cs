...
{
    public class GetNonConfirmedEmployersQueryHandler : IRequestHandler<GetEmployersForConfirmationQuery, List<EmployerViewModel>>
    {
        private readonly IStore _store;
        private readonly IMapper _mapper;

        public GetNonConfirmedEmployersQueryHandler(IStore store, IMapper mapper)
        {
            _store = store;
            _mapper = mapper;
        }
